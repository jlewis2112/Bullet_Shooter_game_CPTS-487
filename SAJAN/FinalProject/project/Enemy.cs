...
namespace project
{
    ...
    class Enemy : Object
    {
        ...
        protected Pattern attackPattern;
        ...
        //need to have a basic attack function. Can be moved to the subclasses if it is too difficult.
        public void basicAttack()
        {
            //add a bullet factory call and place it at
/*            abstractBulletFactory Bullet = new concreteEnemyBullet();
            objectClient newClient = new objectClient();
            newClient.clientBullet(Bullet, 100, .3f, );
